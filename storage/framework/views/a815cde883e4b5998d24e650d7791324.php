        ...
        <form action="<?php echo e(route('category.store')); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" name="category_name" type="text" placeholder="Masukkan nama kategori"
                    aria-label="Nama Kategori" value="<?php echo e(old('category_name')); ?>">
            </div>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('category.edit', $row['id'])); ?>" class="btn btn-success btn-sm">
...
<?php /**PATH /Users/juhn/Herd/LaravelPerpus/resources/views/category/index.blade.php ENDPATH**/ ?>